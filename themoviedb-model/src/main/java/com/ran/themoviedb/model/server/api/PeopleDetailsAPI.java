...
public interface PeopleDetailsAPI {
     ...
     */
    @GET("person/{id}")
    Observable<Response<PeopleDetailResponse>> getPeopleDetailResponse(@Path("id") int id,
    ...
    Observable<Response<PeopleKnownForResponse>> getPeopleKnownForResponse(@Path("id") int id,
                                                                           @Query("api_key") String api_key,
                                                                           @Query("language") String lang);
