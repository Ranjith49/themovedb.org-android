...
public class TvShowSimilarServiceImpl extends BaseRetrofitService<TvShowSimilarDetailsResponse> {
  ...
  protected Call<TvShowSimilarDetailsResponse> getRetrofitCall() {
    TvShowDetailsAPI service = RetrofitAdapters.getAppRestAdapter().create(TvShowDetailsAPI.class);
    return service.getSimilarTvShows(tvShowId, pageIndex, TheMovieDbConstants.APP_API_KEY,
        tvShowLang);
  }
