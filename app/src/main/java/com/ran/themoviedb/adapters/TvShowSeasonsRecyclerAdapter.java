...
public class TvShowSeasonsRecyclerAdapter extends RecyclerView.Adapter {
    ...
    private static class TvShowCustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public TvShowCustomViewHolder(View itemView) {
            super(itemView);
            tvSeasonPoster = itemView.findViewById(R.id.tvSeason_poster);
            tvEpisodes = itemView.findViewById(R.id.tv_show_episodes);
            tvSeasonName = itemView.findViewById(R.id.tv_season_name);
            tvSeasonYear = itemView.findViewById(R.id.tv_season_date);
        }
    }
}
