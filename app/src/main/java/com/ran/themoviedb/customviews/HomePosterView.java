...
public class HomePosterView extends RelativeLayout {
  ...
  protected void onFinishInflate() {
    ...
    imagePoster1 = (ImageView) findViewById(R.id.home_poster_image_1);
    imagePoster2 = (ImageView) findViewById(R.id.home_poster_image_2);
    imagePoster3 = (ImageView) findViewById(R.id.home_poster_image_3);
    bottomTextView = (TextView) findViewById(R.id.home_poster_bottom_name);
  }
